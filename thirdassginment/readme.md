...
1DjaYUiPEH4FeiuvYKZVYjvSTy59JxDehn
15xkWej1sd4ttMr4zxJ7cKScfgZj4i3EZV
...
接对端节点
./cmd -c chain -s ls_ -l 8080 -a 1DjaYUiPEH4FeiuvYKZVYjvSTy59JxDehn -datadir /Users/lisheng/go/src/Course/cmd
...
e.g
curl -1 -X POST -H 'Content-Type: application/json' -d '{"Msg":110}' http://localhost:8080
